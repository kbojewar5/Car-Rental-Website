...
public class RegisterServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			"<a href='login.jsp'>Login</a></li><li class='r'><a href='register.jsp'>Register</a></li><li class= 'r'><a href='#'>Manage Your Reservation</a></li>"+
			...
			if(username != "" && password != ""){
				...
				out.println("<h1> Registered successfully. Confirmation email has been sent to your email ID </h1>");
		 ...
		 final String password1="bojewar0512";
          ...
          Authenticator authenticator = new Authenticator () {
			...
			body+=  "<br>"+
					...
					"<p>Go to website and seacrhc for amazing cars for rent.</p>"+
