...
public class ReserveCar extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
         ...
         final String from = "kaustubh0512@gmail.com";
			String subject="Reservation Confirmation";
		 final String password1="bojewar0512";
          ...
          Authenticator authenticator = new Authenticator () {
			...
			String body="<h1>MidWest Car Rentals</h1>"+
						...
						"<p>Thank you for your recent MidWest Car Rental reservation at"+location+" We hope that the entire experienc"+
			...
			String docType =
				...
				"<a href='/midwest/LogoutServlet' style='font-weight: bold;float:right;margin-right:20px;'>Logout</a>"+
				"</header>");
				out.println("<!DOCTYPE html>" + "<html lang=\"en\">"
					...
					out.println("<li class='r'><a href='register.jsp'>Register</a></li>"
					+ "<li class= 'r'><a href='#'>Manage Your Reservation</a></li>"
